...
public class PageGuideConfig implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/api/imagerepo/**").addResourceLocations("file:///D:/Stu/StumdetRoot/ImageRepo/");
        registry.addResourceHandler("/api/odmoutput/**").addResourceLocations("file:///D:/Stu/StumdetRoot/ODMOutputRoot/");
    }
}
